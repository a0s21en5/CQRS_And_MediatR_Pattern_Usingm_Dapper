...
namespace Repository
{
    public class CourseRepository
    {
        ...
        //Add To Cart
        public void AddToCartInCourse(Course course)
        {
            cmd.CommandText = "INSERT INTO Cart_TB SELECT * FROM Course_TB WHERE Id = @Id";
            cmd.Parameters.AddWithValue("@Id", course.Id);
            cmd.Connection = sqlConnection;
            sqlConnection.Open();
            cmd.ExecuteNonQuery();
        ...
        public void DeleteCourseInCart(Course course)
        {
            cmd.CommandText = "DELETE FROM Cart_TB WHERE Id = @Id";
            cmd.Parameters.AddWithValue("@Id", course.Id);
            cmd.Connection = sqlConnection;
            sqlConnection.Open();
            cmd.ExecuteNonQuery();
        ...
        //All Course in Cart
        public List<Course> GetAllCourseInCart()
        {
            List<Course> courses = new List<Course>();
            cmd.CommandText = "select * from Cart_TB";
            cmd.Connection = sqlConnection;
            sqlConnection.Open();
            SqlDataReader reader = cmd.ExecuteReader();
            while (reader.Read())
        ...
        {
            cmd.CommandText = "select * from User_TB WHERE Name = @Name AND Password = @Password";
            cmd.Parameters.AddWithValue("@Name", user.userName);
            cmd.Parameters.AddWithValue("@Password", user.Password);
            cmd.Connection = sqlConnection;
            sqlConnection.Open();
